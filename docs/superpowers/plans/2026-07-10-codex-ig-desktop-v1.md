...
**Files:** `app/src/screens/Cliques.tsx` · `app/src-tauri/src/tracker.rs` (fetch ao worker `codex-ig-tracker.paulothedeveloper.workers.dev`; chaves lidas do `keyring`, NÃO do front).
